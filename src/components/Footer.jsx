...
const Footer = () => {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-white/70 dark:bg-gray-900/70 backdrop-blur-lg py-5 z-20 border-t border-white/20 dark:border-gray-700/50">
